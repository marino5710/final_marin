...
class Programador extends Conexion{
    ...
    public function modificar(){
        $sql = "UPDATE programadores SET programador_nombre = '$this->programador_nombre', programador_apellido = '$this->programador_apellido' WHERE programador_id = $this->programador_id";
